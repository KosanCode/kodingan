          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>About Us</h1>
                <p data-aos="fade-up" data-aos-delay="100">Tentang KAMABA dan Tim Developer Kami</p>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-4 text-left border-primary">
            <h2 class="font-weight-light text-primary">Our Developer Team</h2>
            <p class="color-black-opacity-5"></p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
            <img src="images/martha.jpg" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Martha Presina</h3>
            <p class="caption text-primary">17.11.1200</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
            <img src="images/valor.jpg" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Valoryan Junsi K.</h3>
            <p class="caption text-primary">17.11.1218</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
            <img src="images/youse.jpg" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Youse Nur Fauzi</h3>
            <p class="caption text-primary">17.11.1219</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
            <img src="images/ivan.jpg" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Yan Gurin Ivanda</h3>
            <p class="caption text-primary">17.11.1254</p>
          </div>
        </div>
